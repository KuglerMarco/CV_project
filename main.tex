...
\begin{figure}[t!]
    \centering
    \subfigure[]{\includegraphics[width=0.5\textwidth]{Task3-2/image_83_alpha.png}}
    \subfigure[]{\includegraphics[width=0.5\textwidth]{Task3-2/image_82_fpn.png}}
...
\begin{figure}[t!]
    \centering
    \subfigure[]{\includesvg[width=0.32\textwidth]{Task4-BiFPN/loss_total_loss15.svg}}
    \vspace{-0.15cm}
    \subfigure[]{\includesvg[width=0.32\textwidth]{Task4-BiFPN/loss_classification_loss15.svg}}
    \subfigure[]{\includesvg[width=0.32\textwidth]{Task4-BiFPN/loss_regression_loss15.svg}}
    \subfigure[]{\includesvg[width=0.32\textwidth]{Task4-BiFPN/metrics_mAP15.svg}}
